...
import { lastUpdated, termsSections } from '@/data/terms';
  ...
  return (
    <>
      <Seo
        ...
        path="/terms"
        description="The terms that govern use of this website and the consulting and course services offered through it."
      />
